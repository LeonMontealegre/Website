...
/******/ 	return __webpack_require__(__webpack_require__.s = "./site/public/heat/index.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Module.onRuntimeInitialized = function () {
    ...
    function step() {
        ...
        canvas.draw(function (p) {
            for (var i = 0; i < N; i++) {
                p.setFillColor(heatMapColorforValue(Module._val(i) / max));
                if (heatMap) {
                    ...
                    p.fillRect(Object(Vector__WEBPACK_IMPORTED_MODULE_1__["V"])(i * s - N * s / 2, 0), Object(Vector__WEBPACK_IMPORTED_MODULE_1__["V"])(s, 50));
                }
            }
        }, !heatMap);
        t++;
